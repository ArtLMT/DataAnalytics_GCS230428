...
In case 2, the data of devices will be make up, simulately analysis 2 type of devices will be choose to be representative for the device, being "Desktop" and "Mobile" In order to figure out which row will on be half of the device, there's a few key to check 1. Mobile user are likely to have high bounce rate while desktop user are mostly stay longer This can make the 2 device be chosen from bounce rate and Duration

2.  Mobile user have "?" chance to have "?" conversion rate due to the convinite ?

    Make up data to see which will present desktop, and which will present mobile
...
**Conclusion** It is clear from the data that desktop users tend to have consistently higher conversion rates, while mobile users appear more scattered and typically perform at lower levels. This difference highlights an opportunity to optimize the mobile experience or shift more advertising effort toward high-converting desktop channels.
